...
const SERVICE_DESCRIPTIONS: Partial<Record<string, string>> = {
  comfort: `Печь, протопленная дровами, нагревает чугунные чушки и специальные камни.
...
Бассейн 1,5 × 2,5 м со специальной водоподготовкой.`,
  elite: `Описание номера «Элит» (заполните текст).`,
};
    ...
    >
      <div className="ls-topbar">
        ...
        <div className="v3-bg-toggle">
          ...
          <button
            type="button"
            className={`v3-bg-toggle__btn ${bgMode === "gradient" ? "active" : ""}`}
